...
<template>
  <section
    id="projects"
    class="relative z-20 flex h-dvh w-full snap-start items-center justify-center overflow-hidden"
  >
    <Grid />
    ...
    <div class="relative z-10 flex w-full max-w-360 flex-col px-4 md:px-8">
      <div class="mb-8 flex items-center justify-between px-4" v-motion="getSlideUp(150)">
        ...
        <div class="hidden gap-2 md:flex md:gap-3" v-motion="getPop(300)">
          <button
            @click="scrollPrev"
