  ...
  >
    ...
    <div class="flex flex-1 flex-col p-6">
      <div class="mb-2 flex flex-col items-start">
        <h3
          class="text-fluid-h3 group-hover:text-brand-primary line-clamp-1 font-black tracking-tight text-slate-950 transition-colors duration-300"
        >
          {{ project.title }}
        </h3>
      </div>

      <p class="text-fluid-base line-clamp-2 leading-relaxed font-medium text-slate-600">
        {{ project.description }}
      </p>
    </div>
